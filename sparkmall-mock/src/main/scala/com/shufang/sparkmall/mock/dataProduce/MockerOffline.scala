...
import com.shufang.sparkmall.common.model.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.shufang.sparkmall.common.util.ConfigurationUtil
import com.shufang.sparkmall.mock.dataProduce.{RanOpt, RandomDate, RandomNum, RandomOptions}
...
object MockerOffline {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //读取config.properties文件，与虚拟机的hive相连接
    val database: String = ConfigurationUtil("config.properties").config
      .getString("hive.database")
